module "internet_of_things" {
  ...
  process_car_parking_lambda_arn = module.process_car_parking_lambda.process_car_parking_lambda_arn
}
...
module "process_car_parking_lambda" {
  source = "./modules/services/lambda/process_car_parking"
...
module "website" {
  ...
  vagasasaservice_website_ecs_cluster_id               = module.application.vagasasaservice_website_ecs_cluster_id
  vagasasaservice_website_ecs_cluster_name             = module.application.vagasasaservice_website_ecs_cluster_name
